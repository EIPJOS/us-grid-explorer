...
function relatedRegions(current) {
  ...
  return `<section class="profile-links region-related"><div><p class="eyebrow">More markets</p><h2>See another region</h2><a class="all-states-link" href="/data-center-permits/">All permit alerts &rarr;</a></div>${others.map((route) => `<a style="border-top:2px solid var(--line)" href="/data-center-permits/${route}/"><span>Permit alerts</span><strong>${route.replace(/-/g, " ")}</strong></a>`).join("")}</section>`;
}
