      ...
      <section className="home-permit-spotlight">
        <div>
          ...
          <p>
            ...
            Loudoun County, VA — rezonings, special exceptions, substations, and the hearing dates
            attached to them — delivered as a weekly digest. Dallas–Fort Worth, Phoenix, Chicago, and
            Atlanta are next.
          </p>
        </div>
